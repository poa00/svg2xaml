...
namespace SvgConverter
{
    ...
    public static class ConverterLogic
    {
        ...
        {
            //Does this help? _nsManager.AddNamespace("", "http://schemas.microsoft.com/winfx/2006/xaml/presentation");
        ...
        private static void InlineClipping(XElement drawingElement)
        {
            ...
            {   //add Attribute: ClipGeometry="M0,0 V40 H40 V0 H0 Z" this is the description of a rectangle-like Geometry (per a comment made in the Issues tab of original repo, editing code to test)
        ...
        {
            //If DrawingGroups are completely dissimilar, the elements of the unnecessary Group are raised one level and that Group is removed
        ...
        private static void CollapsePathGeometries(XElement drawingElement)
        {
            ...
            //var pathGeometries = drawingElement.XPathSelectElements(".//defns:PathGeometry", _nsManager).ToArray(); --> would also work
        ...
        {
            //Here, only the declaration of the namespace is thrown out (purely on a string basis), so that you can paste it
        ...
        /// 
        /// </summary>
        /// <param name="refName">is the already complete name with prefix or reskey</param>
